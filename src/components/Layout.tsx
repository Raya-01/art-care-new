  ...
  return (
    <>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', background: 'linear-gradient(160deg,#FAF5EF 0%,#EEF4F2 100%)', fontFamily: "'Nunito', sans-serif" }}>
        ...
        {/* 👈 Променено: Header се показва за всички (не само за логнати) */}
        <Header />
        ...
        <main
          style={{
            flex: 1,
            paddingTop: '72px',  // 👈 Променено: винаги има paddingTop, защото Header винаги е там
          }}
        >
          <div
        ...
        {/* 👈 Footer се показва само за логнати потребители */}
        {currentUser && <Footer />}
      </div>
    </>
  );
