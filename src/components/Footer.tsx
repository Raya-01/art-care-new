    ...
    <>
      <style>{`
        ...
        .ft-section-title {
          ...
          color: rgba(163,185,149,0.9);
          display: flex; align-items: center; gap: 8px;
          padding-bottom: 14px; margin-bottom: 22px;
          border-bottom: 1.5px solid rgba(163,185,149,0.18);
          transition: color 0.3s, border-color 0.3s;
        }
        .ft-section-title:hover { color: #A3B995; border-bottom-color: rgba(163,185,149,0.3); }
        ...
        @media(max-width: 1024px) { .ft-main-grid { gap: 40px 32px; } }
        @media(max-width: 768px) { .ft-main-grid { grid-template-columns: 1fr 1fr; gap: 36px 28px; } }
        @media(max-width: 540px) { .ft-main-grid { grid-template-columns: 1fr; gap: 32px; } }

        .ft-bottom-row {
          display: flex; align-items: center; justify-content: space-between;
          flex-wrap: wrap; gap: 20px 16px;
        }
        @media(max-width: 768px) { .ft-bottom-row { gap: 18px 12px; } }
        @media(max-width: 640px) { .ft-bottom-row { flex-direction: column; align-items: center; gap: 14px; text-align: center; } }
      `}</style>
      ...
      <footer style={{ background: 'linear-gradient(170deg,#2C3E35 0%,#1A2B25 100%)', fontFamily: "'Nunito', sans-serif" }}>
        ...
        <div style={{ maxWidth: 1400, margin: '0 auto', padding: '64px 32px 0' }}>

          {/* ════ Brand centrepiece ══════════════════════════════════════════ */}
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: 56, gap: 0 }}>
            ...
            {/* Stats row */}
            <div style={{ display: 'flex', gap: 42, marginTop: 24, flexWrap: 'wrap', justifyContent: 'center' }}>
          ...
          {/* ── floral divider ── */}
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 52, opacity: 0.35 }}>
          ...
          {/* ════ Bottom bar ═════════════════════════════════════════════════ */}
          <div style={{ borderTop: '1px solid rgba(163,185,149,0.15)', margin: '48px 0 0', padding: '28px 0 32px' }}>
