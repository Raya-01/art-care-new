...
import {
  ...
  Home, BookOpen, Palette, History, Target, ChevronDown
} from 'lucide-react';
              ...
              <div ref={profileRef} style={{ position: 'relative' }}>
                ...
                {profileOpen && (
                  <div className="anim-rise" style={{
                    ...
                    width: '214px', zIndex: 50, borderRadius: '18px', overflow: 'hidden',
                    background: 'white', border: '1.5px solid #F9DDB8',
                    boxShadow: '0 20px 50px rgba(44,62,53,0.11), 0 4px 12px rgba(232,128,103,0.07)',
                  }}>
                    <div style={{ height: '3px', background: 'linear-gradient(90deg,#E88067,#FBBD96,#F9DDB8,#A3B995)' }} />
                    ...
                    <div style={{ padding: '8px' }}>
                      <Link to="/profile"  className="cc-dropdown-item"><User size={15} /> Моят Профил</Link>
                      <Link to="/settings" className="cc-dropdown-item"><Settings size={15} /> Настройки</Link>
                      <div style={{ margin: '6px 0', borderTop: '1px solid #F9DDB8' }} />
                      <button onClick={handleLogout} className="cc-dropdown-item cc-dropdown-danger"><LogOut size={15} /> Изход</button>
                    </div>
                  </div>
                )}
              </div>
        ...
        <>
          ...
          <div className="anim-rise" style={{
            ...
            <div style={{ padding: '10px 14px 18px', display: 'flex', flexDirection: 'column', gap: '3px' }}>
              ...
              <Link to="/profile"  className="cc-mobile-link"><User size={16} /> Моят Профил</Link>
              <Link to="/settings" className="cc-mobile-link"><Settings size={16} /> Настройки</Link>
              <button onClick={handleLogout} className="cc-mobile-link" style={{ color: '#E88067' }}>
